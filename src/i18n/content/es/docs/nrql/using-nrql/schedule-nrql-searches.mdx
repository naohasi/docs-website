...
<Callout title="avance">
  ...
  Esta función se proporciona actualmente como parte de un programa de vista previa de acuerdo con nuestras [políticas de pre-lanzamiento](/docs/licenses/license-information/referenced-policies/new-relic-pre-release-policy). Durante el período de vista previa, se puede acceder a esta función a través de la [UI de Logs](/docs/logs/ui-data/use-logs-ui), con planes de expansión a otras capacidades después de la disponibilidad general.
</Callout>
